...
class InstallViolinProgramCommand extends Command
{
    protected $signature = 'cleardawn:install-violin-program {userId? : users.id（省略時はユーザーが1人だけならそのユーザー）}';

    protected $description = 'ヴァイオリン復帰プログラム（10週）を登録する（冪等）';

    public function handle(InstallViolinProgramService $service): int
    {
