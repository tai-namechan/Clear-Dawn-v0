...
5. 稼働時間外をclamp
6. 開始順にsort
7. overlapと接しているintervalをmerge
8. merge後busy minutesを算出
9. 30分未満gapを提案対象外
10. 提案候補は長い順で最大5件を選び、表示は開始順
11. keyは`gap_1`等の安定したserver key
