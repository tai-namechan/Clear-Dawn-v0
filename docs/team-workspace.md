...
1. ログイン画面で、個人版とは分離されたチーム専用導線と注意書きを確認します。
2. 「ローカルデモで確認」から入り、概要の4カードが `3名 / 0件 / 13日 / 1名` になることを確認します。
3. 選手一覧で氏名検索、7日間の練習回数・食事記録日数、最終記録を確認します。
4. 選手名を開き、安全な要約だけが表示されることを確認します。
5. PC幅とモバイル幅でサイドバー、4カード、一覧の横スクロールを確認します。
6. ログアウト後、チーム画面へ戻るとログイン画面へ誘導されることを確認します。

レビュー対象は、専用認証、チーム切り替え、概要、選手一覧・検索、選手詳細、所属境界、共有境界です。サイドバーで「準備中」と表示するプログラム、レポート、チーム設定は今回の評価対象外です。
