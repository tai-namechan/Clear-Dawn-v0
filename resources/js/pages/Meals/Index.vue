            ...
            >
                <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                    ...
                    >
                        ...
                        <p class="mt-1 font-sans text-xs text-cd-ink-muted">お気に入り・最近・よく使う</p>
                    </button>
                    <button
                        type="button"
                        class="rounded-2xl border border-cd-line bg-cd-surface px-4 py-4 text-left shadow-sm transition-colors hover:border-primary/40 hover:bg-primary/5"
                    ...
                    >
                        ...
                        <p class="mt-1 font-sans text-xs text-cd-ink-muted">市販商品を初回でも検索</p>
                    </button>
                    <button
                        type="button"
                        class="rounded-2xl border border-cd-line bg-cd-surface px-4 py-4 text-left shadow-sm transition-colors hover:border-primary/40 hover:bg-primary/5"
                    ...
                    >
                        ...
                        <p class="mt-1 font-sans text-xs text-cd-ink-muted">料理をAI推定</p>
                    </button>
                    <button
                        type="button"
                        class="rounded-2xl border border-cd-line bg-cd-surface px-4 py-4 text-left shadow-sm transition-colors hover:border-primary/40 hover:bg-primary/5"
                    ...
                    >
                        ...
                        <p class="mt-1 font-sans text-xs text-cd-ink-muted">店名とメニュー名から推定</p>
                    </button>
                    <button
                        type="button"
                        class="rounded-2xl border border-cd-line bg-cd-surface px-4 py-4 text-left shadow-sm transition-colors hover:border-primary/40 hover:bg-primary/5"
                    ...
                    >
                        ...
                        <p class="mt-3 font-sans text-sm font-semibold text-cd-ink">マイ食品を検索</p>
                        <p class="mt-1 font-sans text-xs text-cd-ink-muted">登録済みの食品から探す</p>
                    </button>
                    <button
                        type="button"
                        class="rounded-2xl border border-cd-line bg-cd-surface px-4 py-4 text-left shadow-sm transition-colors hover:border-primary/40 hover:bg-primary/5"
