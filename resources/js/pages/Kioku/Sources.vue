...
import { SOURCE_TYPES  } from '@/lib/kiokuMeta';
import type {SourceTypeKey} from '@/lib/kiokuMeta';
...
<template>
    <div class="space-y-5">
        ...
        >
            <div class="mb-3 text-[11.5px] font-bold tracking-wide text-os-sub">
                取り込み元
            </div>
            <div
            ...
            <p class="mt-3 text-[11px] leading-relaxed text-os-sub">
                ヨユウ・Clear
