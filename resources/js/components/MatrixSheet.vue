        ...
        <table class="h-full w-full table-fixed border-collapse">
            ...
            <tbody>
                <tr
                    ...
                    :key="row.key"
                    class="h-1/3 border-b border-cd-matrix-line last:border-b-0"
                    :class="{ 'cd-matrix-row-current': row.key === 'current' }"
                >
                    <th
                        scope="row"
                        class="relative bg-cd-matrix-row-header px-5 py-6 text-center align-middle font-normal"
                        :class="{
                    ...
                    >
                        <button
                            type="button"
                            class="pointer-events-none absolute top-2.5 right-2.5 rounded-md border border-cd-matrix-line/80 bg-cd-matrix-surface/90 p-1.5 text-cd-ink-muted opacity-0 shadow-xs transition-all duration-200 group-hover/cell:pointer-events-auto group-hover/cell:opacity-100 hover:border-cd-line hover:bg-white hover:text-cd-ink focus-visible:pointer-events-auto focus-visible:opacity-100"
