...
return [
    ...
    */
    ...
    'google_team_auth' => [
        'client_id' => env('GOOGLE_TEAM_AUTH_CLIENT_ID'),
        'client_secret' => env('GOOGLE_TEAM_AUTH_CLIENT_SECRET'),
        'redirect' => env('GOOGLE_TEAM_AUTH_REDIRECT_URI'),
        'enabled' => (bool) env('GOOGLE_TEAM_AUTH_ENABLED', false),
    ],
