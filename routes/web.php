...
use App\Http\Controllers\BodyMeasurementImportController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::patch('matrix-cells/{matrixCell}/items/reorder', [MatrixCellItemController::class, 'reorder'])->name('matrix-cell-items.reorder');
    ...
    Route::post('records/body-measurements/import', [BodyMeasurementImportController::class, 'store'])
        ->middleware('throttle:10,1')
        ->name('records.body-measurements.import');
